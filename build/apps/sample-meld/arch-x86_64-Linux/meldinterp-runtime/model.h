# 1 "/home/dcampbel/Research/blinkyBocksHardware/build/src-bobby/meldinterp-runtime/model.bbh"
#include "../sim/block.h"
#ifndef __MODEL_H_
#define __MODEL_H_
...
#define TUPLES  (this()->tuples) 
#define OLDTUPLES  (this()->oldTuples) 

#define EVAL_HOST (& (this()->blockId) )
#define PERSISTENT_INITIAL 2
#define PERSISTENT  (this()->persistent) 
#define PROVED  (this()->proved) 
