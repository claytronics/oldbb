...
/* Flags:    [7]   chunk ready    [6]   able to send (ack received)    [3]   send a nack    [2]   send next chunk with even (0) / odd (1) parity    [1]   send an odd parity ack    [0]   send an even parity ack*/
...
/* Flags:    [7] chunk ready    [6] parity of last received chunk    [1] got odd parity ACK    [0] got even parity ACK*/

// typedef struct _receive_packet_queue { Chunk* head; Chunk* tail; byte flags; } ReceivePacketQueue;
/* Flags:    [7] has new packet*/
