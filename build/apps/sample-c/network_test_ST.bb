...
{ 
 ...
 if (isSTLeader) 
 {
   delayMS(1500); // TIME TO VISUALLY CHECK THE LEAVES
   setColor(RED);
   ...
   while ( (getClock() < cycleStartTime + CYCLE_TIME_LIMIT)&&(cycleNum < 100) );
