...
/* In this program, the goal is to move the red color from the start block, to the finish block colored in blue. Every second, the color moves from the current red block to one of its neighbor. The direction of the move is defined by the orientation of the ensemble. If the color leaves the ensemble, you lose. If you reach the blue block, you win. 
