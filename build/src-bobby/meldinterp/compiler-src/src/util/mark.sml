...
sig
    ...
    val error : 'a marked -> string -> string
	...
	val mapFirst : ('a -> ('b * 'c)) -> 'a marked -> ('b marked * 'c)
	val mapFirst' : (('a * 'b) -> ('c * 'd)) -> ('a marked * 'b) -> ('c marked * 'd)
